...
proach was unusual in that our primary goal wasunder-
...
- Membership changes: Raft’s mechanism for
    ...
    joint consensusapproach where the majorities of
...
guishedleader, then giving the leader complete responsi-
...
leader,follower, orcandidate. In normal operation there
...
integers. Each term begins with anelection, in which one
...
called theelection timeout, then it assumes there is no vi-
...
3. The voter must have accepted the committed entry
    from leaderTbeforevoting for leaderU; otherwise it
...
commits it to a majority ofCnew. There is no point in time in
...
toCnew, it stores the configuration for joint consensus
...
a new leader may be chosen under eitherColdorCold,new,
depending on whether the winning candidate has received
Cold,new. In any case,Cnewcannot make unilateral deci-
...
the rules ofCnew, the old configuration is irrelevant and
...
a server fromColdcan be elected leader.
...
A pairedt-test states that, with 95% confidence, the true
...
Equal lecture quality Same lecturer for both. Paxos lecturebased on and improved from exist-
...
KUSTERS, N. P.,ANDLI, P. Paxos replicated state
...
FIKES, A.,ANDGRUBER, R. E. Bigtable: a distributed
...
[9] GRAY, C.,ANDCHERITON, D. Leases: An efficient fault-
...
pp. 245–256.
[13] KIRSCH, J.,ANDAMIR, Y. Paxos for system builders.
...
[21] LAMPSON, B. W. The ABCD’s of Paxos. InProc.
PODC’01, ACM Symposium on Principles of Distributed
Computing(2001), ACM, pp. 13–13.
[22] LISKOV, B.,ANDCOWLING, J. Viewstamped replica-
...
R., DOUCEUR, J. R.,ANDHOWELL, J. The SMART
...
WANs. InProc. OSDI’08, USENIX Conference on
Operating Systems Design and Implementation(2008),
USENIX, pp. 369–384.

[26] MAZIERES` , D. Paxos made practical. [http:](http:)
...
thesis.pdf.
[32] ONGARO, D.,ANDOUSTERHOUT, J. In search of an
...
pp. 1–10.
[39]VANRENESSE, R. Paxos made moderately complex.
