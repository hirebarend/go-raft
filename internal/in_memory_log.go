...
func (l *InMemoryLog) Append(logEntries []LogEntry) error {
...
func (l *InMemoryLog) Get(index uint64) (LogEntry, bool) {
	if len(l.logEntries) == 0 {
...
func (l *InMemoryLog) GetTerm(index uint64) (uint64, bool) {
...
func (l *InMemoryLog) Last() (LogEntry, bool) {
	if len(l.logEntries) == 0 {
		return LogEntry{}, false
	}
...
func (l *InMemoryLog) LastIndex() (uint64, bool) {
	logEntry, ok := l.Last()
...
func (l *InMemoryLog) LastTerm() (uint64, bool) {
	logEntry, ok := l.Last()
...
func (l *InMemoryLog) Truncate(index uint64) {
	if len(l.logEntries) == 0 {
		return
	}
